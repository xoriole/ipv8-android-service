**Builder**: [![](http://jenkins-ci.tribler.org/job/ipv8/job/build_ipv8_android_backend/badge/icon)](http://jenkins-ci.tribler.org/job/ipv8/job/build_ipv8_android_backend/)
